...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Poietic Generator Api Crystal web application."
  #
  #
  ...
  #
  # settings.secret_key_base= CYEEUTa8CqpjSXgvR-ZUZ4sRfxDdokSMDD9Oxsa4s8U
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("poietic-generator-api-crystal.log", "w"))
  #
  #
end
